 ...
 */
public class HoneypotInventoryClickEvent extends Event implements Cancellable {
	...
	/**
	 * Called before a Honeypot is created is taken on a player who broke with
	 * Honeypot inventory. If cancelled, the
